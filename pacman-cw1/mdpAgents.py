...
# The agent here is was initially written by Simon Parsons, based on the code in
# pacmanAgents.py, and finished by Kiem Mark Duc Nguyen for the 2nd piece of 
# coursework in the module 6CCS3AIN.
...
class MDPAgent(Agent):
    ...
    def __init__(self):
        # params
        self.direcProb = 1        # Direction probability (100%)
